...
export interface SidebarViewAll {
  text: string;
  href: string;
}
...
export interface QuickLinks {
  title: string;
  links: SidebarQuickLink[];
}

export interface MyDepartmentWidget {
  title: string;
...
export interface MyContactsWidget {
  title: string;
  tabs: SidebarTab[];
  defaultTab: string;
  contacts: SidebarContact[];
  viewAll: SidebarViewAll;
}

export interface MyDocumentsWidget {
  title: string;
  tabs: SidebarTab[];
  defaultTab: string;
  files: SidebarFile[];
...
export interface SidebarWidgetsContent {
  meta: ContentMeta;
  myDepartment: MyDepartmentWidget;
  myContacts: MyContactsWidget;
  myDocuments: MyDocumentsWidget;
}
