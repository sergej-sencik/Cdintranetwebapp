...
function Main() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[24px] isolate items-center pb-0 pt-0 px-0 relative shrink-0 w-full z-[4]" data-name="Main">
      <Notifications />
      <HeaderSection />
      <Container2 />
    </div>
