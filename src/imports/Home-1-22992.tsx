import svgPaths from "./svg-1axkcah4vo";
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="stars-01">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_1_19790)" id="stars-01">
          <g id="Icon">
            <path d={svgPaths.pf8e9f00} stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d={svgPaths.p182ed8f0} stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </g>
        </g>
        <defs>
          <clipPath id="clip0_1_19790">
...
function AiAssistent() {
  return (
    <div className="bg-gradient-to-l box-border content-stretch flex from-[#6a11cb] gap-[8px] items-center justify-center px-[16px] py-[12px] relative rounded-tl-[8px] rounded-tr-[8px] shadow-[0px_0px_8px_0px_rgba(0,0,0,0.25)] shrink-0 to-[#2575fc] w-[255px]" data-name="AI Assistent">
      <Stars01 />
...
function AiAssistant() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col gap-[8px] h-[736px] items-end justify-end right-0 w-[464px] z-[7]" data-name="AI assistant">
      <AiAssistent />
    </div>
  );
}
...
function NavItemButton() {
  return (
    <div className="box-border content-stretch flex items-center justify-center overflow-clip p-[8px] relative rounded-[6px] shrink-0 w-[40px]" data-name="_Nav item button">
      <Bell01 />
    </div>
  );
}
...
function DropdownHeaderNavigationButton() {
  return (
    <div className="box-border content-stretch flex gap-[2px] items-center justify-center overflow-clip px-[6px] py-[8px] relative rounded-[4px] shrink-0" data-name="_Dropdown header navigation button">
      <TextPadding1 />
      <ChevronDown1 />
    </div>
  );
...
function ButtonsButton2() {
  return (
    <div className="bg-[#00af3f] box-border content-stretch flex gap-[6px] items-center justify-center overflow-clip px-[16px] py-[10px] relative rounded-[4px] shrink-0" data-name="Buttons/Button">
      <TextPadding9 />
    </div>
  );
}
...
function Alert() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[16px] items-start p-[16px] relative rounded-[4px] shrink-0 w-[1216px]" data-name="Alert">
...
function NavMenuItemCard() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative rounded-[8px] shrink-0 w-full" data-name="_Nav menu item card">
      <div className="h-[130px] pointer-events-none relative rounded-[8px] shrink-0 w-[196.364px]" data-name="Image">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover rounded-[8px] size-full" src={imgImage} />
        <div aria-hidden="true" className="absolute border border-[#e9eaeb] border-solid inset-0 rounded-[8px]" />
      </div>
      <HeadingAndText1 />
    </div>
  );
    ...
    <div className="content-stretch flex gap-[24px] items-start relative rounded-[8px] shrink-0 w-full" data-name="_Nav menu item card">
      <div className="h-[130px] pointer-events-none relative rounded-[8px] shrink-0 w-[196.364px]" data-name="Image">
        <div className="absolute inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-full left-[-38.85%] max-w-none top-0 w-[261.9%]" src={imgImage1} />
        </div>
        <div aria-hidden="true" className="absolute border border-[#e9eaeb] border-solid inset-0 rounded-[8px]" />
      </div>
      <HeadingAndText3 />
...
function NavMenuItemCard2() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative rounded-[8px] shrink-0 w-full" data-name="_Nav menu item card">
      <div className="h-[130px] pointer-events-none relative rounded-[8px] shrink-0 w-[196.364px]" data-name="Image">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover rounded-[8px] size-full" src={imgImage2} />
        <div aria-hidden="true" className="absolute border border-[#e9eaeb] border-solid inset-0 rounded-[8px]" />
      </div>
      <HeadingAndText5 />
    </div>
...
function Main() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[24px] isolate items-center pb-0 pt-[24px] px-0 relative shrink-0 w-full z-[4]" data-name="Main">
      <Notifications />
      <HeaderSection />
      <Container2 />
    </div>
...
function ButtonsButton4() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-center overflow-clip relative shrink-0" data-name="Buttons/Button">
      <Edit01 />
      <p className="font-['Roboto:Medium',_sans-serif] font-medium leading-[22px] relative shrink-0 text-[#535862] text-[16px] text-nowrap whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Upravit
      </p>
    </div>
  );
...
function BookOpen01() {
  return (
    <div className="absolute left-[10px] size-[20px] top-[10px]" data-name="book-open-01">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="book-open-01">
...
function FeaturedIcon() {
  return (
    <div className="bg-[#e3f7ff] overflow-clip relative rounded-[4px] shrink-0 size-[40px]" data-name="Featured icon">
      <BookOpen01 />
    </div>
  );
}

function ArrowNarrowRight1() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="arrow-narrow-right">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="arrow-narrow-right">
          <path d={svgPaths.p2cc45a00} id="Icon" stroke="var(--stroke-0, #717680)" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Cta() {
  return (
    <div className="basis-0 bg-white grow h-[162px] min-h-[80px] min-w-px relative rounded-[4px] shrink-0" data-name="CTA">
      <div aria-hidden="true" className="absolute border border-[#e9eaeb] border-solid inset-0 pointer-events-none rounded-[4px] shadow-[0px_1px_3px_0px_rgba(10,13,18,0.05),0px_1px_2px_-1px_rgba(10,13,18,0.05)]" />
      <div className="min-h-inherit size-full">
        <div className="box-border content-stretch flex flex-col gap-[24px] h-[162px] items-start min-h-inherit p-[16px] relative w-full">
          <Frame3 />
          <p className="font-['Roboto:Medium',_sans-serif] font-medium leading-[22px] relative shrink-0 text-[#252b37] text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            Technická dokumentace a manualy
          </p>
        </div>
      </div>
    </div>
...
function PenTool02() {
  return (
    <div className="absolute left-[10px] size-[20px] top-[10px]" data-name="pen-tool-02">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="pen-tool-02">
    ...
    <div className="basis-0 bg-white grow h-[162px] min-h-[80px] min-w-px relative rounded-[4px] shrink-0" data-name="CTA">
      ...
      <div className="min-h-inherit size-full">
        <div className="box-border content-stretch flex flex-col gap-[24px] h-[162px] items-start min-h-inherit p-[16px] relative w-full">
          ...
          <p className="font-['Roboto:Medium',_sans-serif] font-medium leading-[22px] relative shrink-0 text-[#252b37] text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            {`Provozní `}
            <br aria-hidden="true" />a bezpečnostní předpisy
          </p>
        </div>
      </div>
    </div>
...
function IconLayoutDashboard() {
  return (
    <div className="absolute left-[10px] size-[20px] top-[10px]" data-name="icon=layout-dashboard">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
...
function Share03() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="share-03">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="share-03">
          <path d={svgPaths.p2386bb80} id="Icon" stroke="var(--stroke-0, #717680)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function IconFolderOpen() {
  return (
    <div className="absolute left-[10px] size-[20px] top-[10px]" data-name="icon=folder-open">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
...
function LinkExternal02() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="link-external-02">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="link-external-02">
          <path d={svgPaths.p3619bb00} id="Icon" stroke="var(--stroke-0, #717680)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function AlertTriangle() {
  return (
    <div className="absolute left-[10px] size-[20px] top-[10px]" data-name="alert-triangle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="alert-triangle">
...
function Gift01() {
  return (
    <div className="absolute left-[10px] size-[20px] top-[10px]" data-name="gift-01">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
...
function ButtonsButton6() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-center overflow-clip relative shrink-0" data-name="Buttons/Button">
      <p className="font-['Roboto:Medium',_sans-serif] font-medium leading-[22px] relative shrink-0 text-[#0097cf] text-[16px] text-nowrap whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>{`Zobrazit všechny `}</p>
      <ChevronRight2 />
    </div>
  );
}
...
function HorizontalTabs() {
  return (
    <div className="bg-[#009fda] content-stretch flex items-center relative shrink-0 w-full z-[2]" data-name="Horizontal tabs">
      <TabButtonBase />
      <TabButtonBase1 />
      <TabButtonBase2 />
    </div>
...
function Ritgh() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-[384px]" data-name="Ritgh">
      <ActivityFeed />
      <Contacts />
      <Contacts1 />
    </div>
...
function Footer() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[64px] items-center overflow-clip px-0 py-[64px] relative shrink-0 w-[1440px] z-[1]" data-name="Footer">
      <Container5 />
      <Container6 />
    </div>
  );
